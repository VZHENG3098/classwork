...
public class IntroMain {
	...
	public static final String[] NAMES = {"Derek","VincentTheGod","Jonie","David","TheOtherDavid","Kevin","Steven"}; 
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i< numberOfPeople;i++) {
			CodingConventions conventionsInstance = new CodingConventions(i%7,i%2);
